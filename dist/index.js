...
// src/types.ts
var TestMode, LocatorStrategy, ActionStatus, VLMProvider, Platform;
var init_types = __esm({
  "src/types.ts"() {
    TestMode = /* @__PURE__ */ ((TestMode2) => {
      TestMode2["DETERMINISTIC"] = "deterministic";
      TestMode2["VISUAL"] = "visual";
      TestMode2["HYBRID"] = "hybrid";
      return TestMode2;
    })(TestMode || {});
    LocatorStrategy = /* @__PURE__ */ ((LocatorStrategy2) => {
    ...
    ActionStatus = /* @__PURE__ */ ((ActionStatus2) => {
    ...
    VLMProvider = /* @__PURE__ */ ((VLMProvider2) => {
    ...
    CDPAdapter = class {
      ...
      async getScreenshotBase64() {
        ...
        try {
          ...
          const data = fs2.readFileSync(tempPath);
    ...
    PythonBridge = class {
      ...
      constructor(config = {}) {
        ...
        if (!this.config.serverPath) {
          this.config.serverPath = path2.resolve(
            __dirname,
  ...
  "src/vlm/cursor-bridge.ts"() {
    CursorBridge = class {
      ...
      constructor(_config) {
        ...
        this.screenshotDir = path2.join(process.cwd(), ".agent-test-screenshots");
        if (!fs2.existsSync(this.screenshotDir)) {
          fs2.mkdirSync(this.screenshotDir, { recursive: true });
        }
      ...
      saveScreenshot(base64Data) {
        ...
        const filepath = path2.join(this.screenshotDir, filename);
        const cleanData = base64Data.replace(/^data:image\/\w+;base64,/, "");
        fs2.writeFileSync(filepath, Buffer.from(cleanData, "base64"));
        return filepath;
      }
      /**
      ...
      async findElement(request) {
        ...
        const requestFile = path2.join(
          this.screenshotDir,
          `request_${Date.now()}.json`
        );
        fs2.writeFileSync(requestFile, JSON.stringify(analysisRequest, null, 2));
        console.log("\n\u250C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2510");
        ...
        if (fs2.existsSync(responseFile)) {
          const response = JSON.parse(fs2.readFileSync(responseFile, "utf-8"));
          return response;
        }
        return {
          confidence: 0,
...
export { ActionStatus, Assertions, CDPAdapter, CostTracker, DesktopTest, TestMode as HybridMode, LocatorStrategy, NutJSAdapter, Platform, PythonBridge, TestMode, TestRunner, VLMClient, VLMProvider, createDesktopTest };
