 ...
 */
interface CDPAdapterInterface extends Adapter {
    connect(): Promise<void>;
    disconnect(): Promise<void>;
    getSnapshot(options?: {
        interactive?: boolean;
 ...
 */
interface PythonBridgeInterface extends Adapter {
    /** Call Python method */
 ...
 */
interface NutJSAdapterInterface extends Adapter {
...
export { type ActionResult as A, type BoundingBox as B, type CDPAdapterInterface as C, type DesktopTestConfig as D, type ElementLocator as E, type VLMFindRequest as F, type VLMFindResponse as G, VLMProvider as H, LocatorStrategy as L, type NutJSAdapterInterface as N, Platform as P, type Reporter as R, type ScreenshotOptions as S, TestMode as T, type VLMActionRequest as V, type WaitOptions as W, ActionStatus as a, type Adapter as b, type AssertionMethods as c, type CDPConfig as d, type ClickOptions as e, type CostEntry as f, type CostSummary as g, type DesktopTestInstance as h, type ElementRef as i, type LogMethods as j, type NutJSConfig as k, type PythonBridgeConfig as l, type PythonBridgeInterface as m, type ScrollOptions as n, type SnapshotResult as o, type TestCase as p, type TestContext as q, type TestFunction as r, type TestResult as s, type TestSuiteResult as t, type TypeOptions as u, type VLMActionResponse as v, type VLMAssertRequest as w, type VLMAssertResponse as x, type VLMClientInterface as y, type VLMConfig as z };
